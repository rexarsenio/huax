...
def summarise_tanker_activity(payload: object) -> List[PortStaySummary]:
    ...
    for entry in _iter_stays(payload):
        ...
        port_name = port_block.get("name") or port_block.get("portName") or entry.get("portName") or entry.get("port")
        port_code = port_block.get("code") or port_block.get("portCode") or entry.get("portCode")
