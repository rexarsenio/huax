...
RTOFS_URL_TEMPLATE = (
    "https://nomads.ncep.noaa.gov/dods/rtofs/rtofs_global{run_date}/" "rtofs_glo_2ds_forecast_3hrly_prog"
)
RTOFS_DATASET_NAMES: Sequence[str] = ("u", "v", "time", "lon", "lat")

WW3_URL_TEMPLATE = "https://nomads.ncep.noaa.gov/dods/wave/nww3/nww3_global{run_date}/" "nww3hsfc_00z"
