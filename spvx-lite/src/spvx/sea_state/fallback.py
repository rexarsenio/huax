...
class SeaStateFallbackChain:
    ...
    def ingest_with_fallback(self, lookback_days: int = 3, region_list: Optional[list[str]] = None) -> IngestionResult:
        """
    ...
    def _try_cmems(self, lookback_days: int, region_list: Optional[list[str]]) -> IngestionResult:
        ...
        try:
            ...
            return IngestionResult(provider="cmems", status=ProviderStatus.FAILED, error=str(exc))
    ...
    def _try_rtofs(self, region_list: Optional[list[str]]) -> IngestionResult:
        ...
        try:
            ...
            return IngestionResult(provider="rtofs", status=ProviderStatus.FAILED, error=str(exc))
